...
var _reduxThunk = __webpack_require__(398);
...
), document.querySelector('#yelpClone'));
...
var _configs = __webpack_require__(140);
...
var SearchBar = function (_React$Component) {
	...
	_createClass(SearchBar, [{
		...
		value: function render() {
			...
			var thereAreTerms = !!this.props.autoSuggestData.terms;

			var dropdownItems = thereAreTerms ? this.props.autoSuggestData.terms.map(function (term) {
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								...
								_react2.default.createElement(
									"span",
									{ title: "Get your current location", "data-toggle": "tooltip",
		...
		value: function getAutoCompleteContent() {
			var currentKeyword = this.state.currentKeyword;
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
	return {
		search: function search(postObject) {
			dispatch(Actions.search(postObject));
		},
		getAutoCompleteContent: function getAutoCompleteContent(keyword) {
...
var Pagination = function (_React$Component) {
	...
	function Pagination() {
		...
		return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Pagination.__proto__ || Object.getPrototypeOf(Pagination)).call.apply(_ref, [this].concat(args))), _this), _this.setFirstPage = function () {
			...
			var maxNumberOfPage = 1000 / _configs.itemPerPage;
			...
			_this.props.setCurrentPage(prevPage);
	...
	_createClass(Pagination, [{
		...
		value: function render() {
			...
			var maxNumberOfPage = 1000 / _configs.itemPerPage; // Since the number of results is max. 1000
			var isLastPage = currentPage === maxNumberOfPage;
...
/* WEBPACK VAR INJECTION */(function(process) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__createStore__ = __webpack_require__(141);
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(52), __webpack_require__(391)(module)))
...
var AUTOCOMPLETE = exports.AUTOCOMPLETE = "AUTOCOMPLETE";
var SET_PAGE = exports.SET_PAGE = "SET_PAGE";

var search = exports.search = function search(postObject) {
...
var autoComplete = exports.autoComplete = function autoComplete(currentKeyword) {
	return function (dispatch) {
		jQuery.ajax({
...
if (process.env.NODE_ENV !== 'production') {
  ...
  module.exports = __webpack_require__(407)(isValidElement, throwOnDirectAccess);
} else {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_prop_types__ = __webpack_require__(400);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_hoist_non_react_statics__ = __webpack_require__(409);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_hoist_non_react_statics___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_hoist_non_react_statics__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_invariant__ = __webpack_require__(410);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_prop_types__ = __webpack_require__(400);
...
var _BusinessItem = __webpack_require__(377);
...
var _Loading = __webpack_require__(379);
...
var Home = function (_React$Component) {
	...
	_createClass(Home, [{
		key: "componentWillReceiveProps",
		value: function componentWillReceiveProps(nextProps) {
			var thereIsResult = !!nextProps.searchData.businesses && nextProps.searchData.businesses.length > 0;
			var isLoading = this.state.loading === true;
		...
		value: function render() {
			...
			var locationFromLastSearch = this.props.locationFromLastSearch;
			var keywordFromLastSearch = this.props.keywordFromLastSearch;
			var businessData = this.props.searchData.businesses;
			var totalResultFound = !!this.props.searchData.total ? this.props.searchData.total : 0;
			var loading = this.state.loading;

			var searchResultNodes = !!businessData ? this.props.searchData.businesses.map(function (item) {
				return _react2.default.createElement(_BusinessItem2.default, { key: item.id, data: item });
			}) : null;

			var paginationNode = totalResultFound === 0 ? null : _react2.default.createElement(_Pagination2.default, { totalResultFound: totalResultFound
			});
